...
(function(window, document, $, mvtForms2Config) {
  ...
  mvtForms2.send = function(obj) {
    ...
    $.ajax({
      ...
      if (response.message === 'error') {
        target.html('<div class="alert alert-danger" role="alert">' + response.data.message + '</div>');
        ...
        target.html('<div class="alert alert-danger" role="alert">' + response.data.error + '</div>');
        mvtForms2.callbacks.fail(response);
        target.css('display', 'block')
      } else if (response.message === 'send') {
        target.html('<div class="alert alert-success" role="alert">' + response.data.answer + '</div>');
  ...
  mvtForms2.prepareForm = function(obj, mode = !0) {
    let options = '',
      options_json = {},
    ...
    $('.mvtf-product-name').text($('.mvtforms2-product').text());
  ...
  $('.mvtf-rating label').hover(function() {
