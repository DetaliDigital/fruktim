<div class="the_form">
    ...
    <form id="{$formID}_form" class="mvtForm2" method="post">
        ...
        <div class="the_form_div the_form_div_textarea">
            <textarea name="{$formID}_comment" placeholder="Опишите, что вы хотели бы изменить"></textarea>
        </div>

        <div class="the_form_item the_form_item_accept">
            <input type="checkbox" name="{$formID}_accept" checked="checked" id="{$formID}_accept"
                   style="display:none;">
            ...
            <label class="checkbox1_label" for="{$formID}_accept">
                ...
                <!--noindex--><span>С <a href="policy/">правилами обработки</a> персональных данных ознакомлен</span>
                <!--/noindex-->
            </label>
        </div>

        <div class="the_form_div the_form_div_submit">
            <button style="width: 100%;" id="{$formID}_form_submit" class="mvtForms2-tohide" type="submit">Перезвоните мне
            </button>
        </div>
